...
const METRICS = {
    ...
    commercialProfit: { label: '💎 КП (прибыль)', color: '#22c55e', unit: '₽', axis: 'left' },
    profitMargin: { label: '📉 Маржа КП', color: '#84cc16', unit: '%', axis: 'percentage' },
};
        ...
        <div className="bg-slate-900 rounded-2xl p-6 border border-slate-800">
            ...
            {!loading && totals && (
                <div className="grid grid-cols-2 md:grid-cols-6 gap-3 mb-6">
                    ...
                    <div className="bg-slate-800/50 rounded-lg p-3">
                        <div className="text-xs text-slate-500">💎 КП (прибыль)</div>
                        <div className="text-lg font-bold text-green-400">
                            {formatValue(totals.commercialProfit || 0, '₽')} ₽
                        </div>
                    </div>
                    <div className="bg-slate-800/50 rounded-lg p-3">
                    ...
                    <div className="bg-slate-800/50 rounded-lg p-3">
                        <div className="text-xs text-slate-500">Маржа КП</div>
                        <div className="text-lg font-bold text-lime-400">
                            {(totals.profitMargin || 0).toFixed(1)}%
                        </div>
                    </div>
                    <div className="bg-slate-800/50 rounded-lg p-3">
                    ...
                    <div className="bg-slate-800/50 rounded-lg p-3">
                        <div className="text-xs text-slate-500">Ср. чек</div>
                        <div className="text-lg font-bold text-amber-400">
                            {formatValue(totals.avgCheck || 0, '₽')} ₽
                        </div>
                    </div>
                </div>
            )}
